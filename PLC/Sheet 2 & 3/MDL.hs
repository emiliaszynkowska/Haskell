...
happyExpList = Happy_Data_Array.listArray (0,20) ([496,1,2,512,32,8194,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseMDL","Exp","forward","backward","right","left","rotate","int","var","%eof"]
        bit_start = st * 12
        bit_end = (st + 1) * 12
...
data Exp = Forward Int | Backward Int | Right Int | Left Int | Rotate Int deriving Show
