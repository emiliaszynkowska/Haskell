...
happyExpList = Happy_Data_Array.listArray (0,22) ([1984,8196,0,32,8194,512,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseMDL","Exp","X","int","moveforward","movebackward","moveright","moveleft","rotate","%eof"]
        bit_start = st * 12
        bit_end = (st + 1) * 12
...
action_2 (5) = happyGoto action_13
...
action_5 (6) = happyShift action_9
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenMoveForward -> cont 7;
	TokenMoveBackward -> cont 8;
	TokenMoveRight -> cont 9;
	TokenMoveLeft -> cont 10;
	TokenRotate -> cont 11;
	_ -> happyError' ((tk:tks), [])
	}
